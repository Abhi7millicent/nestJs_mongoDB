...
let DataManagementInfoService = class DataManagementInfoService {
    ...
    async update(processId, dataManagementId, dataManagementDto) {
        ...
        const data = await this.processRepository.updateByKey(processId, (0, process_utils_1.findPath)(process_constants_1.PROCESS, 'data_management_info'), dataManagementId, dataManagementDto);
