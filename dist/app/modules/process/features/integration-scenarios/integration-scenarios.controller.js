...
__decorate([
    ...
    (0, swagger_1.ApiBody)({
        description: 'Data to update an integration scenario',
        schema: {
            type: 'object',
            properties: {
                _id: { type: 'string', example: '666d417093b9df8f829b22a3' },
                title: { type: 'string', example: 'Integration Scenario Title' },
                description: {
                    type: 'string',
                ...
                data_provider_authentication: { type: 'string', example: 'OAuth2' },
                data_consumer_authentication: { type: 'string', example: 'BasicAuth' },
                activity_id: {
                    type: 'array',
                    items: { type: 'string' },
