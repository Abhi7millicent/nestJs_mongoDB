...
export class BasicDataController {
  ...
  // @Put('basic-data/:id')
  // @ApiOperation({ summary: 'Delete basic process' })
  // @ApiParam({
  //   name: 'processId',
  //   required: true,
  ...
  // @ApiResponse({
  //   status: 201,
  //   description: 'Activity not updated successfully',
  //   schema: {
  //     type: 'object',
  //     properties: {
  //       updatedData: {
  ...
  //             example: ['SF004'],
  //           },
  //           title: { type: 'string', example: 'Basic process Title' },
  ...
  //           error: {
  //             type: 'string',
  //             example: 'Failed to delete basic process',
  //           },
  //         },
  //       },
  //     },
  ...
  @ApiResponse({ status: 200, type: UpdatedDataDto })
  @ApiResponse({
    status: 500,
    description: 'Failed to delete basic process',
